...
namespace ArcCreate.Gameplay.Scenecontrol
{
    ...
    public class NoiseChannel : ValueChannel
    {
        ...
        public NoiseChannel(ValueChannel frequency, ValueChannel min, ValueChannel max, ValueChannel offset, ValueChannel octave)
        {
            this.octave = octave;
        ...
        {
            int octaveVal = (int)Mathf.Max(octave.ValueAt(timing), 1);
            float at = (timing + offset.ValueAt(timing)) / 1000f * frequency.ValueAt(timing);
            float noise = octaveVal == 1 ? Perlin.Noise(at) : Perlin.Fbm(at, octaveVal);
