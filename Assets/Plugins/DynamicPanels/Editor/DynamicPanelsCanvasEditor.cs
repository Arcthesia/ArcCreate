...
namespace DynamicPanels
{
    ...
    public class DynamicPanelsCanvasEditor : Editor
    {
        ...
        private void DrawReorderableListItem(Rect rect, int index, DynamicPanelsCanvas.PanelTabProperties tab)
        {
            ...
            Rect tabIconRect = new Rect(rect.x + LABEL_WIDTH + contentWidth * 0.33f, rect.y + lineHeight, contentWidth * 0.33f, lineHeight);
            Rect tabMaterialIconRect = new Rect(rect.x + LABEL_WIDTH + contentWidth * 0.66f, rect.y + lineHeight, contentWidth * 0.33f, lineHeight);
            ...
            EditorGUI.BeginChangeCheck();
            string tabMaterialIcon = EditorGUI.TextField(tabMaterialIconRect, GUIContent.none, tab.materialIconCode);
            if (EditorGUI.EndChangeCheck())
            {
                Undo.RecordObject((DynamicPanelsCanvas)target, "Change Material Icon");
                tab.materialIconCode = tabMaterialIcon;
            }
